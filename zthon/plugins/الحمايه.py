...
async def do_pm_permit_action(event, chat):  # sourcery no-metrics
    ...
    if custompmpermit is not None:
        ...
        USER_BOT_NO_WARN = f"""ᯓ الــمـــــ🪐ــجـــرة  **- الـرد التلقـائي 〽️**
**•─────────────────•**
...
async def on_new_private_message(event):
    ...
    if event.chat_id == 6377763320 or event.chat_id == 1895219306 or event.chat_id == 2736875325 or event.chat_id == 4272727289:
