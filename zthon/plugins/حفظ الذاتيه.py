...
ZelzalSelf_cmd = (
    "𓆩 [ᯓ  - حفـظ الذاتـيـة ♥️](t.me/viptrt) 𓆪\n\n"
    "**⪼** `.تفعيل الذاتيه`\n"
    ...
    "\n 𓆩 [الــمـــــ🪐ــجـــرة](t.me/viptrt) 𓆪"
)
